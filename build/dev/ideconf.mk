...
IDECONF_INCLUDE_DIRS = genstone/gencore/include genstone/genuine/include genstone/gencalc/include genstone/genfx/include genstone/vendor/safeclib/include genstone/vendor/mimalloc/include
ifeq ($(PLATFORM),DWN)
IDECONF_INCLUDE_DIRS += genstone/gencore/threademu/include
endif
IDECONF_DEFINES = DEBUG=1 RELEASE=0 ENABLED=1 DISABLED=0 PLATFORM=$(PLATFORM) DWN=2 LNX=3 MODE=DEBUG

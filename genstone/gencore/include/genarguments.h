...
typedef struct {
     ...
     */
    gen_size_t* short_argument_indices;

    /**
     * Parameters to short arguments in `short_argument_indices` parsed out of the argument array passed to `gen_arguments_parse`.
     * Each entry corresponds to an entry in `short_argument_indices` - for arguments which recieved no parameter, the entry will be `GEN_NULL`.
     */
     ...
     */
    gen_size_t* short_argument_parameter_lengths;
     ...
     */
    gen_size_t short_argument_count;
     ...
     * Each entry corresponds to an entry in `long_argument_indices` - for arguments which recieved no parameter, the entry will be `GEN_NULL`.
     */

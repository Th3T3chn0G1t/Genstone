...
typedef enum {
    GEN_JAN, GEN_FEB, GEN_MAR, GEN_APR, GEN_JUN, GEN_JLY, GEN_AUG, GEN_SEP, GEN_OCT, GEN_NOV, GEN_DEC
} gen_month_t;
 ...
 * @return an error code
 */
extern GEN_ERRORABLE_RETURN gen_locale_convert_date_and_time(char* const out_string, size_t* const restrict out_size, const uint64_t year, const gen_month_t month, const uint8_t day, const uint8_t hours, const uint8_t minutes, const uint8_t seconds);

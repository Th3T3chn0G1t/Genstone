GEN_TESTS_CFLAGS = $(GEN_CORE_CFLAGS)
GEN_TESTS_CFLAGS += -I$(GENSTONE_DIR)/genstone/gentests/include
...
$(GEN_TESTS_LIB): CFLAGS = $(GEN_CORE_CFLAGS) $(GENSTONE_DIAGNOSTIC_CFLAGS)

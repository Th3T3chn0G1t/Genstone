_SPIRV_COMMON_CFLAGS = -Igenstone/vendor/SPIRV-Headers/include -Igenstone/vendor/SPIRV-Reflect -Igenstone/vendor/SPIRV-Tools/include -Igenstone/vendor/SPIRV-Tools/source -Igenstone/vendor/SPIRV-Headers/include/spirv/unified1/ -Wno-availability -Wno-nullability-completeness -Wno-expansion-to-defined -DTARGET_OS_IPHONE=0
...
SPIRV_INSTS = genstone/vendor/SPIRV-Tools/source/debuginfo.insts.inc genstone/vendor/SPIRV-Tools/source/nonsemantic.clspvreflection.insts.inc genstone/vendor/SPIRV-Tools/source/nonsemantic.shader.debuginfo.100.insts.inc genstone/vendor/SPIRV-Tools/source/opencl.debuginfo.100.insts.inc genstone/vendor/SPIRV-Tools/source/spv-amd-gcn-shader.insts.inc genstone/vendor/SPIRV-Tools/source/spv-amd-shader-ballot.insts.inc genstone/vendor/SPIRV-Tools/source/spv-amd-shader-explicit-vertex-parameter.insts.inc genstone/vendor/SPIRV-Tools/source/spv-amd-shader-trinary-minmax.insts.inc genstone/vendor/SPIRV-Tools/source/spv-amd-shader-ballot.insts.inc
...
SPIRV_CXX_SOURCES = $(wildcard genstone/vendor/SPIRV-Tools/source/*.cpp) $(wildcard genstone/vendor/SPIRV-Tools/source/val/*.cpp) $(wildcard genstone/vendor/SPIRV-Tools/source/util/*.cpp) $(wildcard genstone/vendor/SPIRV-Tools/source/opt/*.cpp)

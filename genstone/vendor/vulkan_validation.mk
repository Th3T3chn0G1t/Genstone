...
_VULKAN_VALIDATION_LFLAGS = $(_VULKAN_VALIDATION_COMMON_LFLAGS) $(VULKAN_LFLAGS) $(SPIRV_LFLAGS)
...
$(VULKAN_VALIDATION_LIB): CFISAN_FLAGS = -fno-lto
$(VULKAN_VALIDATION_LIB): $(VULKAN_VALIDATION_OBJECTS) $(SPIRV_LIB) $(VULKAN_LIB) | lib

clean_vulkan_validation:
	@$(ECHO) "$(ACTION_PREFIX)"
	-rm $(VULKAN_VALIDATION_OBJECTS)
	-rm $(VULKAN_VALIDATION_LIB)
	-rm $(VULKAN_VALIDATION_REDIRECT)
	@$(ECHO) "$(ACTION_SUFFIX)"

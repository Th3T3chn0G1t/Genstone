...
gencalc_test: gencalc build_message_gencalc_test $(GEN_CALC_TEST) ### @Test Builds and runs Genstone mathematics utility tests
...
$(GEN_CALC_TEST_OBJECTS): $(GEN_CORE_LIB)
